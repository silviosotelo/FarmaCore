...
* Plugin URI:  https://themeforest.net/user/KlbTheme
* Version:     1.5.0.4
* Author:      KlbTheme
...
final class Bacola_Elementor_Addons
{
    ...
    */
    public function init()
    {
		...
		/* Newsletter */
        require_once( __DIR__ . '/newsletter-popup/newsletter-main.php' );
		...
		/* Maintenance */
		if(get_theme_mod('bacola_maintenance_toggle', 0) == 1 || bacola_ft() == 'maintenance'){
    ...
    */
    public function init_widgets()
    {
		...
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Home_Slider_Widget() );
		
		// Banner Box
		require_once( __DIR__ . '/elementor/widgets/bacola-banner-box.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Banner_Box_Widget() );
		
		// Banner Box 2
		require_once( __DIR__ . '/elementor/widgets/bacola-banner-box2.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Banner_Box2_Widget() );
		
		// Banner Box 3
		require_once( __DIR__ . '/elementor/widgets/bacola-banner-box3.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Banner_Box3_Widget() );
		
		// Banner Box 4
		require_once( __DIR__ . '/elementor/widgets/bacola-banner-box4.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Banner_Box4_Widget() );
		
		// Banner Box 5
		require_once( __DIR__ . '/elementor/widgets/bacola-banner-box5.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Banner_Box5_Widget() );
		
		// Product Grid
		require_once( __DIR__ . '/elementor/widgets/bacola-product-grid.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Product_Grid_Widget() );
		
		// Product Grid 2
		require_once( __DIR__ . '/elementor/widgets/bacola-product-grid2.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Product_Grid2_Widget() );

		// Product Carousel
		require_once( __DIR__ . '/elementor/widgets/bacola-product-carousel.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Product_Carousel_Widget() );
		
		// Special Products
		require_once( __DIR__ . '/elementor/widgets/bacola-special-products.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Special_Products_Widget() );
		
		// Product List
		require_once( __DIR__ . '/elementor/widgets/bacola-product-list.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Product_List_Widget() );
		
		// Deal Carousel
		require_once( __DIR__ . '/elementor/widgets/bacola-deal-carousel.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Deal_Carousel_Widget() );
		
		// Text Banner
		require_once( __DIR__ . '/elementor/widgets/bacola-text-banner.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Text_Banner_Widget() );
		
		// Icon List
		require_once( __DIR__ . '/elementor/widgets/bacola-icon-list.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Icon_List_Widget() );
		
		// Testimonial
		require_once( __DIR__ . '/elementor/widgets/bacola-testimonial.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Testimonial_Widget() );
		
		// Product Categories
		require_once( __DIR__ . '/elementor/widgets/bacola-product-categories.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Product_Categories_Widget() );
		
		// Category Banner
		require_once( __DIR__ . '/elementor/widgets/bacola-category-banner.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Category_Banner_Widget() );
		
		// Category Banner 2
		require_once( __DIR__ . '/elementor/widgets/bacola-category-banner2.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Category_Banner2_Widget() );
		
		// Latest Blog
		require_once( __DIR__ . '/elementor/widgets/bacola-latest-blog.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Latest_Blog_Widget() );
		
		// Counter Product
		require_once( __DIR__ . '/elementor/widgets/bacola-counter-product.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Counter_Product_Widget() );
		
		// Hero Banner
		require_once( __DIR__ . '/elementor/widgets/bacola-hero-banner.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Hero_Banner_Widget() );
		
		// Icon Box
		require_once( __DIR__ . '/elementor/widgets/bacola-icon-box.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Icon_Box_Widget() );
		
		// Contact Form 7
		require_once( __DIR__ . '/elementor/widgets/bacola-contact-form-7.php' );
		\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Contact_Form_7_Widget() );

		// Vendor Grid
		if (function_exists('get_wcmp_vendor_settings')) {
			require_once( __DIR__ . '/elementor/widgets/bacola-vendor-grid.php' );
			\Elementor\Plugin::instance()->widgets_manager->register( new \Elementor\Bacola_Vendor_Grid_Widget() );
		}
