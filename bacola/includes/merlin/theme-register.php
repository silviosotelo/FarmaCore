...
function bacola_register_theme() {
	add_menu_page( esc_html__( 'KlbTheme', 'bacola' ), esc_html__( 'KlbTheme', 'bacola' ), 'manage_options', 'klbtheme_options', 'bacola_register_theme_options', 'dashicons-welcome-widgets-menus', 2);
	add_submenu_page( 'klbtheme_options', esc_html__('Register Theme', 'bacola'), esc_html__('Register Theme', 'bacola'), 'manage_options', 'klbtheme_options', 'bacola_register_theme_options' );
	add_submenu_page( 'klbtheme_options', esc_html__('Theme Options', 'bacola'), esc_html__('Theme Options', 'bacola'), 'manage_options', 'customize.php?return=admin.php?page=klbtheme_options' );
}
...
function bacola_register_theme_options() {
	...
	<?php if(!empty(bacola_get_registered_purchase_code())){ ?>
		<div class="klb-help-container registered-container">
			...
			<div class="registered-right"> 
				<h2><?php esc_html_e('The theme registered','bacola'); ?></h2>
				<p><?php esc_html_e('Envato allows 1 license for 1 project located on 1 domain. It means that 1 purchase key can be used only for 1 site. Each additional site will require an additional purchase key.','bacola'); ?></p>
			</div>
		</div>
	<?php } ?>
	...
	<div class="klb-help-container">
		<div class="klb-help-item">
			<a href="https://klbtheme.com/doc/bacola" target="_blank">
				...
				<h2><?php esc_html_e('Documentation', 'bacola'); ?></h2>
			</a>
		</div>
		...
		<div class="klb-help-item">
			<a href="https://themeforest.net/user/klbtheme#contact" target="_blank">
				...
				<h2><?php esc_html_e('Reset License', 'bacola'); ?></h2>
			</a>
		</div>
		...
		<div class="klb-help-item">
			<a href="https://klbtheme.ticksy.com/" target="_blank">
				...
				<h2><?php esc_html_e('Support', 'bacola'); ?></h2>
			</a>
		</div>
		...
		<div class="klb-help-item">
			<a href="https://klbtheme.com/hire-us/" target="_blank">
				...
				<h2><?php esc_html_e('Hire Us', 'bacola'); ?></h2>
			</a>
		</div>
	</div>
	...
	if(empty(bacola_get_registered_purchase_code())){
		...
		<div class="c-inner klbtheme-status">
			<h2><?php esc_html_e( 'WordPress', 'bacola' ); ?></h2>
			<div class="klb-table klb-odd">
				<div class="klb-table-row">
					<div>
						<?php esc_html_e( 'Theme Name', 'bacola' ); ?>:
					</div>
					<div>
				...
				<div class="klb-table-row">
					<div>
						<?php esc_html_e( 'Theme Version', 'bacola' ); ?>:
					</div>
					<div>
				...
				<div class="klb-table-row">
					<div>
						<?php esc_html_e( 'WP Version', 'bacola' ); ?>:
					</div>
					<div>
				...
				<div class="klb-table-row">
					<div>
						<?php esc_html_e( 'WP Multisite', 'bacola' ); ?>:
					</div>
					<div>
						<?php echo is_multisite() ? esc_html__( 'Yes', 'bacola' ) : esc_html__( 'No', 'bacola' ); ?>
					</div>
				</div>

				<div class="klb-table-row">
					<div>
						<?php esc_html_e( 'WP Debug Mode', 'bacola' ); ?>:
					</div>
					<div>
						<?php echo defined( 'WP_DEBUG' ) && WP_DEBUG ? esc_html__( 'Enabled', 'bacola' ) : esc_html__( 'Disabled', 'bacola' ); ?>
					</div>
				</div>
			</div>
			<h2><?php esc_html_e( 'Server', 'bacola' ); ?></h2>
			<div class="klb-table klb-odd">

				<div class="klb-table-row">
					<div>
						<?php esc_html_e( 'PHP Version', 'bacola' ); ?>:
					</div>
					<div>
						<?php if ( version_compare( PHP_VERSION, '7.2', '<' ) ) : ?>
							<div class="klb-status-error">
								...
								<span>
									<?php esc_html_e( 'Minimum required PHP version 7.2', 'bacola' ); ?>
								</span>
							</div>
						<?php else : ?>
							<?php echo esc_html( PHP_VERSION ); ?>
				...
				<?php if ( function_exists( 'ini_get' ) ) : ?>
					<div class="klb-table-row">
						<div>
							...
							<?php esc_html_e( 'PHP Post Max Size', 'bacola' ); ?>:
						</div>
						...
						<div>
							<?php if ( wp_convert_hr_to_bytes( $post_max_size ) < 64000000 ) : ?>
								<div class="klb-status-error">
									...
									<span>
										<?php esc_html_e( 'Minimum required value 64M.', 'bacola' ); ?>
									</span>
								</div>
							<?php else : ?>
								<?php echo esc_html( $post_max_size ); ?>
					...
					<div class="klb-table-row">
						<div>
							...
							<?php esc_html_e( 'PHP Time Limit', 'bacola' ); ?>:
						</div>
						...
						<div>
							<?php if ( $max_execution_time < 180 ) : ?>
								<div class="klb-status-error">
									...
									<span>
										<?php esc_html_e( 'Minimum required value 180.', 'bacola' ); ?>
									</span>
								</div>
							<?php else : ?>
								<?php echo esc_html( $max_execution_time ); ?>
					...
					<div class="klb-table-row">
						<div>
							...
							<?php esc_html_e( 'PHP Max Input Vars', 'bacola' ); ?>:
						</div>
						...
						<div>
							<?php if ( $max_input_vars < 10000 ) : ?>
								<div class="klb-status-error">
									...
									<span>
										<?php esc_html_e( 'Minimum required value 10000.', 'bacola' ); ?>
									</span>
								</div>
							<?php else : ?>
								<?php echo esc_html( $max_input_vars ); ?>
					...
					<div class="klb-table-row">
						<div>
							...
							<?php esc_html_e( 'PHP Memory Limit', 'bacola' ); ?>:
						</div>
						...
						<div>
							<?php if ( wp_convert_hr_to_bytes( $memory_limit ) < 128000000 ) : ?>
								<div class="klb-status-error">
									...
									<span>
										<?php esc_html_e( 'Minimum required value 128M.', 'bacola' ); ?>
									</span>
								</div>
							<?php else : ?>
								<?php echo esc_html( $memory_limit ); ?>
					...
					<div class="klb-table-row">
						<div>
							...
							<?php esc_html_e( 'PHP Upload Max Size', 'bacola' ); ?>:
						</div>
						<div>
					...
					<div class="klb-table-row">
						<div>
							<?php esc_html_e( 'PHP Function "file_get_content"', 'bacola' ); ?>:
						</div>
						<div>
							<?php if ( ! ini_get( 'allow_url_fopen' ) || 'Off' === ini_get( 'allow_url_fopen' ) ) : ?>
								<div class="klb-status-error">
									<?php esc_html_e( 'Off', 'bacola' ); ?>
								</div>
							<?php else : ?>
								<?php esc_html_e( 'On', 'bacola' ); ?>
							<?php endif; ?>
						</div>
					</div>
				<?php endif; ?>
				...
				<div class="klb-table-row">
					<div>
						<?php esc_html_e( 'DOMDocument', 'bacola' ); ?>:
					</div>
					<div>
						<?php if ( ! class_exists( 'DOMDocument' ) ) : ?>
							<div class="klb-status-error">
								<?php esc_html_e( 'No', 'bacola' ); ?>
							</div>
						<?php else : ?>
							<?php esc_html_e( 'Yes', 'bacola' ); ?>
						<?php endif; ?>
					</div>
				</div>
				...
				<div class="klb-table-row">
					<div>
						<?php esc_html_e( 'Active Plugins', 'bacola' ); ?>:
					</div>
					<div>
						<?php if ( is_multisite() ) : ?>
...
function bacola_notice_for_activation() {
	...
	if(empty(bacola_get_registered_purchase_code())){
		...
		echo '<div class="notice notice-warning">
			...
			'<a href="' . admin_url('admin.php?page=klbtheme_options') . '">' . esc_html__( 'Enter Purchase Code', 'bacola' ) . '</a>') . '</p>
		</div>';
	}
}